...
function FormularioProducto() {
  ...
  const { agregarProducto, editarProducto, validar } = useProducts(); // Quitamos convertirNumeroArgentino de aquí
  ...
  // Función helper para convertir números argentinos (copiada de CartContext)
  ...
  const manejarEnvio = async (e) => {
    ...
    try {
      const productoEnviar = {
        ...producto,
        // Mantener el precio como string (ya validado por el contexto)
    ...
    <form onSubmit={manejarEnvio} style={{ maxWidth: '600px', margin: '0 auto', padding: '20px' }}>
      ...
      <div style={{ marginBottom: '15px' }}>
        ...
        <div style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>
          Formato argentino: puntos para miles, coma para decimales. Ej: 1.234,56
        </div>
      ...
      <div style={{ marginBottom: '15px' }}>
        ...
        <input
          ...
          onChange={manejarCambio}
          disabled={cargando}
          placeholder="Ej: Juegos de Mesa, Cartas, Estrategia, etc."
          style={{
            width: '100%',
            padding: '8px',
